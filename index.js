...
🔗 Your Invite Link:
https://t.me/axumbingobot?start=${chatId}
...
🎁 Invite now and start earning while having fun!
  ...
  if (text && text.trim().toLowerCase() === "broadcast") {
    states[chatId] = {
      step: "awaiting_text",
      messageText: "",
      photos: [],
